...
export const goalSchema = z.object({
  ...
  color: z.string(),
  cadence: z.string(),
  weekly_target: z.preprocess((val) => val ?? 0, z.number()),
  archived: z.preprocess((val) => val ?? false, z.boolean()),
});
...
export const goalContributionSchema = z.object({
  ...
  goal_id: z.string(),
  date: z.string(),
  checked: z.preprocess((val) => val ?? 0, z.number()),
...
export type GoalStorage = ToStorageType<typeof goalSchema>;
export type GoalContributionStorage = ToStorageType<typeof goalContributionSchema>;
