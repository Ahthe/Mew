        ...
        return (
          <Link
            ...
            className={cn([
              ...
              selected
                ? ["bg-white", "text-[#2a2622]", "border-[#eadfd7]"]
                : [
                    "bg-transparent",
                    "text-[#817b74]",
                    "border-transparent",
...
function WindowShell({
  ...
  return (
    <div className="relative min-h-[calc(100vh-280px)] overflow-hidden rounded-[18px] border border-[#eadfd7] bg-white shadow-[0_30px_80px_-45px_rgba(64,44,32,0.45)]">
      <div className="flex h-11 items-center border-b border-[#eadfd7] bg-[#f7f2ee]">
