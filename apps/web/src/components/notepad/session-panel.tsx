...
export function SessionPanel({
  ...
  return (
    <>
      <div
        className="relative cursor-text px-6 pt-8 pb-24 sm:px-10"
        onClick={handleBodyClick}
      >
        <div className="mb-1 text-[13px] font-medium tracking-wide text-[#e45745]">
          {displayDate}
        </div>
        <input
          ref={titleInputRef}
          ...
          className="w-full border-none bg-transparent font-serif text-3xl font-medium text-[#2a2622] placeholder:text-[#b7afa6] focus:outline-hidden"
        />
        ...
        {hasTabs ? (
          <div className="mt-4 flex flex-col">
            <div className="flex items-center gap-1 border-b border-[#f0e7e0] pb-2">
              <TabButton
                label="Summary"
