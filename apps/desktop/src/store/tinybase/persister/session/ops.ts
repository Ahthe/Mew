// moveSession/renameFolder are domain-specific folder operations (they encode
// session-directory layout), not generic storage primitives, so they stay on the
// fs-sync plugin rather than behind the StorageAdapter seam. A non-filesystem
// backend (PWA) would reimplement folder moves at this layer.
