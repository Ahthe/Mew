  ...
  if (isGenerating) {
    return (
      <div className="flex h-[28px] w-full items-center">
        <span className="animate-pulse font-serif text-3xl font-medium text-char-faint">
          Generating title...
        </span>
      </div>
    );
  ...
  if (showRevealAnimation && generatedTitle) {
    return (
      <div className="flex h-[28px] w-full items-center overflow-hidden">
        <span className="animate-reveal-left font-serif text-3xl font-medium whitespace-nowrap text-char-ink">
          {generatedTitle}
        </span>
      </div>
    );
        ...
        <div className="flex w-full items-center gap-2">
          <input
            ...
            className={cn([
              ...
              "font-serif text-3xl font-medium text-char-ink placeholder:text-char-faint",
            ])}
          />
          {onGenerateTitle && (
