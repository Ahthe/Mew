...
> = {
  neutral: {
    selected: ["bg-char-card", "text-char-ink", "border-char-line"],
    unselected: ["bg-transparent", "text-char-muted", "border-transparent"],
    hover: {
      selected: "text-char-ink hover:text-char-ink",
      unselected: "text-char-muted hover:text-char-ink",
    },
  },
  red: {
