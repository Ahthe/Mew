  ...
  return (
    <div
      ...
      className={cn([
        ...
        "rounded-xl bg-char-card/70",
        isSidebarHidden && "pl-3",
      ])}
    >
      {isSidebarHidden && <TrafficLights className="mr-2" />}
      ...
      <div className="relative h-full min-w-0">
        ...
        {!scrollState.atStart && (
          <div className="pointer-events-none absolute top-0 left-0 z-20 h-full w-8 bg-linear-to-r from-char-card to-transparent" />
        )}
        {!scrollState.atEnd && (
          <div className="pointer-events-none absolute top-0 right-0 z-20 h-full w-8 bg-linear-to-l from-char-card to-transparent" />
        )}
      </div>
...
export function StandardTabWrapper({
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="relative flex flex-1 flex-col overflow-hidden rounded-xl border border-char-line bg-char-card">
        {children}
        {floatingButton}
